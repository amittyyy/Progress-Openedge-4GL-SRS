...
break by ttru.ttruc by cpal.cpaln:
  ...
  do:
    ...
    space (10) if v-vak06 = "" then "" else v-vak06 format 'X(80)' skip(20).
    ...
    */
    ...
    vVak13a = "! " + entry(1,v-vak13,chr(11)).
    vVak13b = "! " + entry(2,v-vak13,chr(11)) no-error.
    vVak13c = "! " + entry(3,v-vak13,chr(11)) no-error.
